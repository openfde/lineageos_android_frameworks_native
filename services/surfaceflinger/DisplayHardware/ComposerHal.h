...
public:
    ...
    virtual V2_1::Error setLayerName(Display display, Layer layer, std::string name) = 0;
    virtual V2_1::Error setLayerHandleInfo(Display display, Layer layer, const sp<GraphicBuffer>& buffer) = 0;
